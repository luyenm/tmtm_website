...
Now you can rename `src/App.css` to `src/App.scss` and update `src/Header.js` to import `src/App.scss`.
...
Import required reactstrap components within `src/Header.js` file or your custom component files:

```js
import { Button } from 'reactstrap';
```

Now you are ready to use the imported reactstrap components within your component hierarchy defined in the render method. Here is an example [`Header.js`](https://gist.githubusercontent.com/zx6658/d9f128cd57ca69e583ea2b5fea074238/raw/a56701c142d0c622eb6c20a457fbc01d708cb485/Header.js) redone using reactstrap.
